...
class awGA(Ui_Dialog_GA):
    
    def moea_awGA(self,AIM_M, AIM_F, PUN_M, PUN_F, FieldDR, problem, R_num,maxormin, MAXGEN, MAXSIZE, NIND, SUBPOP, GGAP, selectStyle, recombinStyle, recopt, pm, distribute, drawing = 1):
