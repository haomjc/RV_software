...
class q_sorted(Ui_Dialog_GA):

    def moea_q_sorted(self,AIM_M, AIM_F, PUN_M, PUN_F, FieldDR, problem, R_num,maxormin, MAXGEN, MAXSIZE, NIND, SUBPOP, GGAP, selectStyle, recombinStyle, recopt, pm, distribute, drawing = 1):
        ...
        for gen in range(MAXGEN):
            ...
            if PUN_F is not None:
                FitnVSel = punishing.punishing(LegVSel, FitnVSel) # 调用罚函数作进一步的惩罚
