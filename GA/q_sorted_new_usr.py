...
class q_sorted_new(Ui_Dialog_GA):

    def moea_q_sorted_new(self,AIM_M, AIM_F, PUN_M, PUN_F, FieldDR, problem, R_num,maxormin, MAXGEN, MAXSIZE, NIND, SUBPOP, GGAP, selectStyle, recombinStyle, recopt, pm, distribute, drawing = 1):
        ...
        for gen in range(MAXGEN):
            ...
            [ObjVSel, LegVSel] =  aimfuc.aimfunction.aimfuc(self,SelCh, LegV) # 求目标函数值        
            # 父子合并
